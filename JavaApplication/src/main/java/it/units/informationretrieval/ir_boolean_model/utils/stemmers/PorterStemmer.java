 ...
 * <p>
 * This class has been adapted from <a href="https://tartarus.org/martin/PorterStemmer/java.txt">Source</a>.
 */
...
class PorterStemmer implements Stemmer {
     ...
     * It reads text from a list of files, stems each word, and writes the result to standard
    ...
    public static void main(String[] args) {
        ...
        InputStream in = new BufferedInputStream(new ByteArrayInputStream(
                ("""
                        ...
                        Will leave us never an understanding friend.""").getBytes()));
   ...
   */
   ...
   /* step3() maps double suffices to single ones. so -ization ( = -ize plus
    ...
    public String stem(@NotNull String input, @NotNull Language language) {
        if (language.equals(Language.ENGLISH)) { // stemmer available only for English
            PorterStemmer porterStemmer = new PorterStemmer();
            porterStemmer.add(input.toCharArray(), input.length());
            porterStemmer.stem();
